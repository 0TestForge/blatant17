  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-gradient-to-br from-accent to-blue-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center bubblegum-animate md:w-16 md:h-16"
